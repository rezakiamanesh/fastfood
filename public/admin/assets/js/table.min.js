!function (n) {
    ...
    function o(t, e) {
        return n[e] || (n[e] = new RegExp(wt(e), "g")), "string" == typeof t && "." !== e ? t.replace(/\./g, "").replace(n[e], ".") : t
    }
    ...
    var v, S, e, t, I = function (w) {
            this.$ = function (t, e) {
                return this.api(!0).$(t, e)
            }, this._ = function (t, e) {
                return this.api(!0).rows(t, e).data()
            }, this.api = function (t) {
                return new S(t ? oe(this[v.iApiIndex]) : this)
            ...
            var T = this, C = w === V, x = this.length;
            for (var t in C && (w = {}), this.oApi = this.internal = v.internal, I.ext.internal) t && (this[t] = Ne(t));
            return this.each(function () {
                var o, i = 1 < x ? se({}, w, !0) : w, l = 0, t = this.getAttribute("id"), s = !1, e = I.defaults,
                    u = U(this);
                if ("table" == this.nodeName.toLowerCase()) {
                    P(e), R(e.column), F(e, e, !0), F(e.column, e.column, !0), F(e, U.extend(i, u.data()));
                    var n = I.settings;
                    ...
                    U.extend(!0, p, i.oLanguage), p.sUrl && (U.ajax({
                        dataType: "json", url: p.sUrl, success: function (t) {
                            L(t), F(e.oLanguage, t), U.extend(!0, p, t), Rt(f)
                        }, error: function () {
                            Rt(f)
                        }
                    ...
                    var v, m = [], S = this.getElementsByTagName("thead");
                    if (0 !== S.length && (ct(f.aoHeader, S[0]), m = ft(f)), null === i.aoColumns) for (v = [], l = 0, o = m.length; l < o; l++) v.push(null); else v = i.aoColumns;
                    for (l = 0, o = v.length; l < o; l++) N(f, m ? m[l] : null);
                    ...
                    var y = f.oFeatures, _ = function () {
                        ...
                        if (0 === r.length && 0 < e.length && ("" !== f.oScroll.sX || "" !== f.oScroll.sY) && (r = U("<tfoot/>").appendTo(u)), 0 === r.length || 0 === r.children().length ? u.addClass(d.sNoFooter) : 0 < r.length && (f.nTFoot = r[0], ct(f.aoFooter, f.nTFoot)), i.aaData) for (l = 0; l < i.aaData.length; l++) W(f, i.aaData[l]); else !f.bDeferLoading && "dom" != pe(f) || B(f, U(f.nTBody).children("tr"));
                        f.aiDisplay = f.aiDisplayMaster.slice(), !(f.bInitialised = !0) === s && Rt(f)
                    };
    ...
    function F(n, a, r) {
        var o;
        n._hungarianMap || y(n), U.each(a, function (t, e) {
    ...
    function H(t, e, n) {
        ...
        n !== V && null !== n && (R(n), F(I.defaults.column, n), n.mDataProp === V || n.mData || (n.mData = n.mDataProp), n.sType && (a._sManualType = n.sType), n.className && !n.sClass && (n.sClass = n.className), n.sClass && o.addClass(n.sClass), U.extend(a, n), le(a, n, "sWidth", "sWidthOrig"), n.iDataSort !== V && (a.aDataSort = [n.iDataSort]), le(a, n, "aDataSort"));

        function l(t) {
            return "string" == typeof t && -1 !== t.indexOf("@")
        }

        var s = a.mData, u = Y(s), c = a.mRender ? Y(a.mRender) : null;
    ...
    function T(t, e) {
        var n = O(t, "bVisible"), a = U.inArray(e, n);
        return -1 !== a ? a : null
    }
    ...
    function et(n, a, t, e) {
        ...
        if ("dom" !== t && (t && "auto" !== t || "dom" !== l.src)) {
            var s = l.anCells;
            if (s) if (e !== V) r(s[e], e); else for (o = 0, i = s.length; o < i; o++) r(s[o], o)
    ...
    function at(t, e, n, a) {
        ...
        if (null === u.nTr) {
            for (r = n || m.createElement("tr"), u.nTr = r, u.anCells = f, r._DT_RowIndex = e, rt(t, u), l = 0, s = t.aoColumns.length; l < s; l++) i = t.aoColumns[l], (o = n ? a[l] : m.createElement(i.sCellType))._DT_CellIndex = {
                row: e,
                column: l
    ...
    function lt(t) {
        ...
        if (-1 === U.inArray(!1, e)) {
            ...
            if (0 !== u.length) for (var d = s ? 0 : c, h = s ? t.aoData.length : f, p = d; p < h; p++) {
                ...
                1 == t.iDraw && "ajax" == pe(t) ? S = i.sLoadingRecords : i.sEmptyTable && 0 === t.fnRecordsTotal() && (S = i.sEmptyTable), n[0] = U("<tr/>", {class: o ? r[0] : ""}).append(U("<td />", {
                    valign: "top",
                    colSpan: k(t),
                    class: t.oClasses.sRowEmpty
                }).html(S))[0]
            }
            fe(t, "aoHeaderCallback", "header", [U(t.nTHead).children("tr")[0], Q(t), c, f, u]), fe(t, "aoFooterCallback", "footer", [U(t.nTFoot).children("tr")[0], Q(t), c, f, u]);
            var D = U(t.nTBody);
    ...
    function ut(t) {
        ...
        for (var i, l, s, u, c, f, d = t.sDom.split(""), h = 0; h < d.length; h++) {
            if (i = null, "<" == (l = d[h])) {
                ...
                o.append(s), o = U(s)
            } else if (">" == l) o = o.parent(); else if ("l" == l && r.bPaginate && r.bLengthChange) i = Ht(t); else if ("f" == l && r.bFilter) i = vt(t); else if ("r" == l && r.bProcessing) i = Mt(t); else if ("t" == l) i = Bt(t); else if ("i" == l && r.bInfo) i = Ft(t); else if ("p" == l && r.bPaginate) i = kt(t); else if (0 !== I.ext.feature.length) for (var g = I.ext.feature, b = 0, v = g.length; b < v; b++) if (l == g[b].cFeature) {
                i = g[b].fnInit(t);
                break
            }
            if (i) {
                var m = t.aanFeatures;
                m[l] || (m[l] = []), m[l].push(i), o.append(i)
            }
        }
    ...
    function ct(t, e) {
        ...
        for (o = 0, s = h.length; o < s; o++) for (0, r = (a = h[o]).firstChild; r;) {
            if ("TD" == r.nodeName.toUpperCase() || "TH" == r.nodeName.toUpperCase()) for (c = (c = 1 * r.getAttribute("colspan")) && 0 !== c && 1 !== c ? c : 1, f = (f = 1 * r.getAttribute("rowspan")) && 0 !== f && 1 !== f ? f : 1, u = n(t, o, 0), d = 1 === c, l = 0; l < c; l++) for (i = 0; i < f; i++) t[o + i][u + l] = {
                cell: r,
                unique: d
            }, t[o + i].nTr = a;
            r = r.nextSibling
    ...
    function dt(r, t, e) {
        ...
        }), n, r) : r.sAjaxSource || "string" == typeof l ? r.jqXHR = U.ajax(U.extend(c, {url: l || r.sAjaxSource})) : "function" == typeof l ? r.jqXHR = l.call(s, t, n, r) : (r.jqXHR = U.ajax(U.extend(c, l)), l.data = a)
    }
    ...
    function pt(t) {
        ...
        var e, a, r, o, i = t.aoColumns, l = i.length, s = t.oFeatures, u = t.oPreviousSearch, c = t.aoPreSearchCols,
            f = [], d = Yt(t), h = t._iDisplayStart, p = !1 !== s.bPaginate ? t._iDisplayLength : -1;
        ...
        s.bFilter && (n("sSearch", u.sSearch), n("bRegex", u.bRegex)), s.bSort && (U.each(d, function (t, e) {
            g.order.push({column: e.col, dir: e.dir}), n("iSortCol_" + t, e.col), n("sSortDir_" + t, e.dir)
    ...
    function gt(t, n) {
        ...
        var a = bt(t, n), r = e("sEcho", "draw"), o = e("iTotalRecords", "recordsTotal"),
            i = e("iTotalDisplayRecords", "recordsFiltered");
        if (r) {
            if (1 * r < t.iDraw) return;
            t.iDraw = 1 * r
        }
        K(t), t._iRecordsTotal = parseInt(o, 10), t._iRecordsDisplay = parseInt(i, 10);
    ...
    function vt(n) {
        ...
        var u = U("<div/>", {id: o.f ? null : e + "_filter", class: t.sFilter}).append(U("<label/>").append(l)),
    ...
    function _t(t, e, n, a) {
        t = e ? t : wt(t), n && (t = "^(?=.*?" + U.map(t.match(/"[^"]+"|[^ ]+/g) || [""], function (t) {
            if ('"' === t.charAt(0)) {
                var e = t.match(/^"(.*)"$/);
                t = e ? e[1] : t
            }
    ...
    var wt = I.util.escapeRegex, Tt = U("<div>")[0], Ct = Tt.textContent !== V;

    function xt(t) {
        var e, n, a, r, o, i, l, s, u = t.aoColumns, c = I.ext.type.search, f = !1;
        for (n = 0, r = t.aoData.length; n < r; n++) if (!(s = t.aoData[n])._aFilterData) {
            for (i = [], a = 0, o = u.length; a < o; a++) (e = u[a]).bSearchable ? (l = x(t, n, a, "filter"), c[e.sType] && (l = c[e.sType](l)), null === l && (l = ""), "string" != typeof l && l.toString && (l = l.toString())) : l = "", l.indexOf && -1 !== l.indexOf("&") && (Tt.innerHTML = l, l = Ct ? Tt.textContent : Tt.innerText), l.replace && (l = l.replace(/[\r\n]/g, "")), i.push(l);
    ...
    function Lt(t) {
        ...
        if (0 !== e.length) {
            ...
            i !== o && (l += " " + n.sInfoFiltered), l = Pt(t, l += n.sInfoPostFix);
    ...
    function kt(t) {
        ...
        var e = t.sPaginationType, f = I.ext.pager[e], d = "function" == typeof f,
            ...
            fn: function (t) {
                if (d) {
                    var e, n, a = t._iDisplayStart, r = t._iDisplayLength, o = t.fnRecordsDisplay(), i = -1 === r,
                        l = i ? 0 : Math.ceil(a / r), s = i ? 1 : Math.ceil(o / r), u = f(l, s);
    ...
    function Bt(t) {
        ...
        var r = n.sX, o = n.sY, i = t.oClasses, l = e.children("caption"), s = l.length ? l[0]._captionSide : null,
            u = U(e[0].cloneNode(!1)), c = U(e[0].cloneNode(!1)), f = e.children("tfoot"), d = "<div/>";
        f.length || (f = null);
        var h = U(d, {class: i.sScrollWrapper}).append(U(d, {class: i.sScrollHead}).css({
            overflow: "hidden",
            position: "relative",
            border: 0,
            width: r ? a(r) : "100%"
        }).append(U(d, {class: i.sScrollHeadInner}).css({
            "box-sizing": "content-box",
            width: n.sXInner || "100%"
        }).append(u.removeAttr("id").css("margin-left", 0).append("top" === s ? l : null).append(e.children("thead"))))).append(U(d, {class: i.sScrollBody}).css({
            position: "relative",
            overflow: "auto",
            width: a(r)
        }).append(e));
        f && h.append(U(d, {class: i.sScrollFoot}).css({
            overflow: "hidden",
            border: 0,
            width: r ? a(r) : "100%"
        }).append(U(d, {class: i.sScrollFootInner}).append(c.removeAttr("id").css("margin-left", 0).append("bottom" === s ? l : null).append(e.children("tfoot")))));
        var p = h.children(), g = p[0], b = p[1], v = f ? p[2] : null;
    ...
    function Et(n) {
        ...
        var e, a, r, o, i, l, s, u, c, f = n.oScroll, d = f.sX, h = f.sXInner, p = f.sY, g = f.iBarWidth,
            b = U(n.nScrollHead), v = b[0].style, m = b.children("div"), S = m[0].style, D = m.children("table"),
            y = n.nScrollBody, _ = U(y), w = y.style, T = U(n.nScrollFoot).children("div"), C = T.children("table"),
            x = U(n.nTHead), I = U(n.nTable), A = I[0], F = A.style, L = n.nTFoot ? U(n.nTFoot) : null, P = n.oBrowser,
            R = P.bScrollOversize, j = X(n.aoColumns, "nTh"), N = [], H = [], k = [], O = [],
            M = y.scrollHeight > y.clientHeight;
        if (n.scrollBarVis !== M && n.scrollBarVis !== V) return n.scrollBarVis = M, void J(n);
        n.scrollBarVis = M, I.children("thead, tfoot").remove(), L && (l = L.clone().prependTo(I), a = L.find("tr"), o = l.find("tr")), i = x.clone().prependTo(I), e = x.find("tr"), r = i.find("tr"), i.find("th, td").removeAttr("tabindex"), d || (w.width = "100%", b[0].style.width = "100%"), U.each(ft(n, i), function (t, e) {
            s = q(n, t), e.style.width = n.aoColumns[s].sWidth
        }), L && Ut(function (t) {
            t.style.width = ""
        }, o), c = I.outerWidth(), "" === d ? (F.width = "100%", R && (I.find("tbody").height() > y.offsetHeight || "scroll" == _.css("overflow-y")) && (F.width = zt(I.outerWidth() - g)), c = I.outerWidth()) : "" !== h && (F.width = zt(h), c = I.outerWidth()), Ut(t, r), Ut(function (t) {
            k.push(t.innerHTML), N.push(zt(U(t).css("width")))
        }, r), Ut(function (t, e) {
            ...
            t.innerHTML = '<div class="dataTables_sizing">' + k[e] + "</div>", t.childNodes[0].style.height = "0", t.childNodes[0].style.overflow = "hidden", t.style.width = N[e]
        }, r), L && Ut(function (t, e) {
        ...
        }, o), I.outerWidth() < c ? (u = y.scrollHeight > y.offsetHeight || "scroll" == _.css("overflow-y") ? c + g : c, R && (y.scrollHeight > y.offsetHeight || "scroll" == _.css("overflow-y")) && (F.width = zt(u - g)), "" !== d && "" === h || ie(n, 1, "Possible column misalignment", 6)) : u = "100%", w.width = zt(u), v.width = zt(u), L && (n.nScrollFoot.style.width = zt(u)), p || R && (w.height = zt(A.offsetHeight + g));
        var W = I.outerWidth();
        D[0].style.width = zt(W), S.width = zt(W);
        var B = I.height() > y.clientHeight || "scroll" == _.css("overflow-y"),
            E = "padding" + (P.bScrollbarLeft ? "Left" : "Right");
        S[E] = B ? g + "px" : "0px", L && (C[0].style.width = zt(W), T[0].style.width = zt(W), T[0].style[E] = B ? g + "px" : "0px"), I.children("colgroup").insertBefore(I.children("thead")), _.scroll(), !n.bSorted && !n.bFiltered || n._drawHold || (y.scrollTop = 0)
    }
    ...
    function Xt(t) {
        var e, n, a, r = t.nTable, o = t.aoColumns, i = t.oScroll, l = i.sY, s = i.sX, u = i.sXInner, c = o.length,
            f = O(t, "bVisible"), d = U("th", t.nTHead), h = r.getAttribute("width"), p = r.parentNode, g = !1,
            b = t.oBrowser, v = b.bScrollOversize, m = r.style.width;
        for (m && -1 !== m.indexOf("%") && (h = m), e = 0; e < f.length; e++) null !== (n = o[f[e]]).sWidth && (n.sWidth = qt(n.sWidthOrig, p), g = !0);
        if (v || !g && !s && !l && c == k(t) && c == d.length) for (e = 0; e < c; e++) {
            var S = q(t, e);
            null !== S && (o[S].sWidth = zt(d.eq(e).width()))
        } else {
            ...
            for (e = 0; e < f.length; e++) {
                var T = U(d[e]), C = T.outerWidth() - T.width(),
                    x = b.bBounding ? Math.ceil(d[e].getBoundingClientRect().width) : T.outerWidth();
                w += x, o[f[e]].sWidth = zt(x - C)
            }
            r.style.width = zt(w), _.remove()
        }
    ...
    function qt(t, e) {
        if (!t) return 0;
        var n = U("<div/>").css("width", zt(t)).appendTo(e || m.body), a = n[0].offsetWidth;
        return n.remove(), a
    }
    ...
    function Yt(t) {
        ...
        var n, a, r, o, i, l, s, u = [], c = t.aoColumns, f = t.aaSortingFixed, d = U.isPlainObject(f), h = [];
        for (U.isArray(f) && e(f), d && f.pre && e(f.pre), e(t.aaSorting), d && f.post && e(f.post), n = 0; n < h.length; n++) for (a = 0, r = (o = c[s = h[n][0]].aDataSort).length; a < r; a++) l = c[i = o[a]].sType || "string", h[n]._idx === V && (h[n]._idx = U.inArray(h[n][1], c[i].asSorting)), u.push({
            src: s,
            col: i,
            dir: h[n][1],
            index: h[n]._idx,
    ...
    function Zt(t) {
        ...
        for (C(t), e = 0, n = (c = Yt(t)).length; e < n; e++) (r = c[e]).formatter && o++, ne(t, r.col);
    ...
    function te(e, t, n, a) {
        ...
        ue(t, {}, function (t) {
            !1 !== r.bSortable && (e.oFeatures.bProcessing ? (Wt(e, !0), setTimeout(function () {
                Kt(e, n, t.shiftKey, a), "ssp" !== pe(e) && Wt(e, !1)
            }, 0)) : Kt(e, n, t.shiftKey, a))
        })
    }
    ...
    function ie(t, e, n, a) {
        if (n = "DataTables warning: " + (t ? "table id=" + t.sTableId + " - " : "") + n, a && (n += ". For more information about this error, please see http://datatables.net/tn/" + a), e) A.console && console.log && console.log(n); else {
            ...
            if (t && fe(t, null, "error", [t, a, n]), "alert" == o) toast(n); else {
    ...
    S = function (t, e) {
        ...
        function n(t) {
            var e = function (t) {
                var e, n, a = I.settings, r = U.map(a, function (t, e) {
                    return t.nTable
                });
                return t ? t.nTable && t.oApi ? [t] : t.nodeName && "table" === t.nodeName.toLowerCase() ? -1 !== (e = U.inArray(t, r)) ? [a[e]] : null : t && "function" == typeof t.settings ? t.settings().toArray() : ("string" == typeof t ? n = U(t) : t instanceof U && (n = t), n ? n.map(function (t) {
        ...
        var a = [];
        if (U.isArray(t)) for (var r = 0, o = t.length; r < o; r++) n(t[r]); else n(t);
        this.context = D(a), e && U.merge(this, e), this.selector = {
            rows: null,
            cols: null,
            opts: null
        }, S.extend(this, this, ge)
        ...
        any: function () {
            ...
            var e = this.context;
            return e.length > t ? new S(e[t], this[t]) : null
        }, filter: function (t) {
            var e = [];
            ...
            var t = [];
            return new S(this.context, t.concat.apply(t, this.toArray()))
            ...
            if (d.length || a) {
                var b = new S(h, t ? d.concat.apply([], d) : d), v = b.selector;
            ...
            return new S(this.context, D(this))
        }, unshift: be.unshift
    }), S.extend = function (t, e, n) {
        if (n.length && e && (e instanceof S || e.__dt_wrapper)) {
            var a, r, o, i = function (e, n, a) {
                return function () {
                    var t = n.apply(e, arguments);
                    return S.extend(t, t, a.methodExt), t
                }
            };
            for (a = 0, r = n.length; a < r; a++) e[(o = n[a]).name] = "function" == typeof o.val ? i(t, o.val, o) : U.isPlainObject(o.val) ? {} : o.val, e[o.name].__dt_wrapper = !0, S.extend(t, e[o.name], o.propExt)
        }
    }, S.register = e = function (t, e) {
        if (U.isArray(t)) for (var n = 0, a = t.length; n < a; n++) S.register(t[n], e); else {
    ...
    }, S.registerPlural = t = function (t, e, n) {
        S.register(t, n), S.register(e, function () {
            var t = n.apply(this, arguments);
            return t === this ? this : t instanceof S ? t.length ? U.isArray(t[0]) ? new S(t.context, t[0]) : t[0] : V : t
        })
    };
    e("tables()", function (t) {
        return t ? new S(function (t, n) {
    ...
    e("rows()", function (e, n) {
        e === V ? e = "" : U.isPlainObject(e) && (n = e, e = ""), n = Se(n);
        var t = this.iterator("table", function (t) {
            return function (s, t, u) {
                var c;
                return me("row", t, function (n) {
        ...
        var t = this.iterator("table", function (t) {
            var e, n, a, r = [];
            for (n = 0, a = o.length; n < a; n++) (e = o[n]).nodeName && "TR" === e.nodeName.toUpperCase() ? r.push(B(t, e)[0]) : r.push(W(t, e));
            return r
        }, 1), e = this.rows(-1);
        ...
        var t = this.iterator("table", function (t) {
            return e.nodeName && "TR" === e.nodeName.toUpperCase() ? B(t, e)[0] : W(t, e)
        });
        return this.row(t[0])
    });
    ...
    var Te = function (s) {
        var r = new S(s), t = ".dt.DT_details", e = "draw" + t, n = "column-visibility" + t, a = "destroy" + t,
            u = s.aoData;
        r.off(e + " " + n + " " + a), 0 < X(u, "_details").length && (r.on(e, function (t, e) {
            ...
            if (s === e) for (var r, o = k(e), i = 0, l = u.length; i < l; i++) (r = u[i])._details && r._details.children("td[colspan]").attr("colspan", o)
        }), r.on(a, function (t, e) {
    ...
    e(xe, function (t, e) {
        var n = this.context;
        return t === V ? n.length && this.length ? n[0].aoData[this[0]]._details : V : (!0 === t ? this.child.show() : !1 === t ? _e(this) : n.length && this.length && function (o, t, e, n) {
            var i = [], l = function (t, e) {
                if (U.isArray(t) || t instanceof U) for (var n = 0, a = t.length; n < a; n++) l(t[n], e); else if (t.nodeName && "tr" === t.nodeName.toLowerCase()) i.push(t); else {
                    ...
                    U("td", r).addClass(e).html(t)[0].colSpan = k(o), i.push(r[0])
                }
            };
            l(e, n), t._details && t._details.detach(), t._details = U(i), t._detailsShow && t._details.insertAfter(t.nTr)
        }(n[0], n[0].aoData[this[0]], t, e), this)
    }), e([Ce + ".show()", xe + ".show()"], function (t) {
        return we(this, !0), this
    }), e([Ce + ".hide()", xe + ".hide()"], function () {
        return we(this, !1), this
    }), e([Ce + ".remove()", xe + ".remove()"], function () {
        return _e(this), this
    }), e(Ce + ".isShown()", function () {
        var t = this.context;
    ...
    e("columns()", function (e, n) {
        ...
        var t = this.iterator("table", function (t) {
            return function (s, t, u) {
                var c = s.aoColumns, f = X(c, "sName"), d = X(c, "nTh");
                return me("column", t, function (n) {
                    var t = h(n);
        ...
        return this.iterator("column-rows", function (t, e, n, a, r) {
            return g(t.aoData, r, "search" === o ? "_aFilterData" : "_aSortData", e)
        }, 1)
    }), t("columns().nodes()", "column().nodes()", function () {
        return this.iterator("column-rows", function (t, e, n, a, r) {
            return g(t.aoData, r, "anCells", e)
        }, 1)
        ...
        var t = this.iterator("column", function (t, e) {
            ...
            !function (t, e, n) {
                ...
                if (s.bVisible !== n) {
                    ...
                    s.bVisible = n, it(t, t.aoHeader), it(t, t.aoFooter), t.aiDisplay.length || U(t.nTBody).find("td[colspan]").attr("colspan", k(t)), ae(t)
                }
            }(t, e, n)
        });
    ...
    e("cells()", function (e, t, n) {
        if (U.isPlainObject(e) && (e.row === V ? (n = e, e = null) : (n = t, t = null)), U.isPlainObject(t) && (n = t, t = null), null === t || t === V) return this.iterator("table", function (t) {
            return function (a, t, e) {
                var r, o, i, l, s, u, c, f = a.aoData, d = ye(a, e), n = b(g(f, d, "anCells")),
                    h = U([].concat.apply([], n)), p = a.aoColumns.length;
                return me("cell", t, function (t) {
        ...
        var a, r, o, i, l, s = this.columns(t), u = this.rows(e);
        this.iterator("table", function (t, e) {
            for (a = [], r = 0, o = u[e].length; r < o; r++) for (i = 0, l = s[e].length; i < l; i++) a.push({
                row: u[e][r],
                column: s[e][i]
            })
        }, 1);
        var c = this.cells(a, n);
        return U.extend(c.selector, {cols: t, rows: e, opts: n}), c
        ...
        return t === V ? e.length && n.length ? x(e[0], n[0].row, n[0].column) : V : (E(e[0], n[0].row, n[0].column, t), et(e[0], n[0].row, "data", n[0].column), this)
        ...
        return e === V ? 0 !== t.length ? t[0].oPreviousSearch.sSearch : V : this.iterator("table", function (t) {
            t.oFeatures.bFilter && mt(t, U.extend({}, t.oPreviousSearch, {
                sSearch: e + "",
                bRegex: null !== n && n,
                bSmart: null === a || a,
        ...
        renderer: null,
        rowId: "DT_RowId"
    }, y(I.defaults), I.defaults.column = {
        aDataSort: null,
        iDataSort: -1,
        asSorting: ["asc", "desc"],
        bSearchable: !0,
        ...
        sType: null,
        sWidth: null
    }, y(I.defaults.column), I.models.oSettings = {
        oFeatures: {
            bAutoWidth: null,
            bDeferRender: null,
            bFilter: null,
    ...
    U.extend(Fe, {
        ...
        pageButton: {
            _: function (l, t, s, e, u, c) {
                var f, d, n, h = l.oClasses, p = l.oLanguage.oPaginate, g = l.oLanguage.oAria.paginate || {}, b = 0,
                    v = function (t, e) {
                        function n(t) {
                            Ot(l, t.data.action, !0)
                        }

                        var a, r, o;
                        for (a = 0, r = e.length; a < r; a++) if (o = e[a], U.isArray(o)) {
                            var i = U("<" + (o.DT_el || "div") + "/>").appendTo(t);
                            v(i, o)
                        } else {
                            switch (f = null, d = "", o) {
                                case"ellipsis":
                            ...
                            }).html(f).appendTo(t), {action: o}, n), b++)
                        }
                    };
                try {
                    n = U(t).find(m.activeElement).data("dt-idx")
                } catch (t) {
                }
        ...
        html: function (t) {
            ...
            return r(t) ? t : "string" == typeof t ? t.replace(l, " ") : t
        }
    });
    var Pe = function (t, e, n, a) {
        return 0 === t || t && "-" !== t ? (e && (t = o(t, e)), t.replace && (n && (t = t.replace(n, "")), a && (t = t.replace(a, ""))), 1 * t) : -1 / 0
    };
    ...
    function Re(n) {
        U.each({
            ...
            v.type.order[t + n + "-pre"] = e, t.match(/^html\-/) && (v.type.search[t + n] = v.type.search.html)
        })
    }

    U.extend(v.type.order, {
        "date-pre": function (t) {
            var e = Date.parse(t);
    ...
    return S.extend(!0, o.defaults, {
        ...
        var f, d, n, h = new o.Api(l), p = l.oClasses, g = l.oLanguage.oPaginate, b = l.oLanguage.oAria.paginate || {},
            v = 0, m = function (t, e) {
                function n(t) {
                    t.preventDefault(), S(t.currentTarget).hasClass("disabled") || h.page() == t.data.action || h.page(t.data.action).draw("page")
                }

                var a, r, o, i;
                for (a = 0, r = e.length; a < r; a++) if (i = e[a], S.isArray(i)) m(t, i); else {
                    switch (d = f = "", i) {
                        case"ellipsis":
                            f = "&#x2026;", d = "disabled";
                            break;
                    ...
                    f && (o = S("<li>", {
                        ...
                        tabindex: l.iTabIndex,
                        class: "page-link"
                    }).html(f)).appendTo(t), l.oApi._fnBindAction(o, {action: i}, n), v++)
                }
            };
        try {
            n = S(t).find(a.activeElement).data("dt-idx")
        } catch (t) {
        }
        m(S(t).empty().html('<ul class="pagination"/>').children("ul"), e), n !== r && S(t).find("[data-dt-idx=" + n + "]").focus()
    }, o
});
