                                ...
                                @foreach($contact as $val)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <a @can('panel.contact.status') href="{{ route('panel.contact.status' , ['id' => $val->id])  }}" @endcan>
                                        ...
                                        <td class="text-center">
                                            ...
                                            @can('panel.contact.modalDetails')
                                                <button type="button"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <span class="btn btn-warning">ایمیل : {{ $val->email }}</span>
                                                </div>
                                    ...
                                    <div class="modal fade" id="deleteModel{{$val->id}}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form
                                                            action="{{ route('panel.contact.delete' , ['id' => $val->id])  }}"
                                                            method="post">
                                                        @csrf
                                                        {{ method_field('DELETE')  }}
