                ...
                <div class="header">
                    <h2>
                        ...
                        <div class="pull-left margin-5">
                            @can('panel.tag.index')
                                <a href="{{ route('panel.tag.index')  }}"
                                   class="btn btn-outline-default btn-border-radius"> لیست برچسب ها </a>
                            @endcan
                        </div>
                    </h2>
                    ...
                    <ul class="header-dropdown m-r--5">
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu pull-right">
                                ...
                                @can('panel.tag.index')
                                    <li>
                                        <a href="{{ route('panel.tag.index')  }}" style="font-size: 10px">لیست
                                            برچسب ها</a>
                                    </li>
                                @endcan
                            </ul>
                ...
                <div class="body">
                    ...
                    @if(isset($find))
                        <form class="form-horizontal" method="post"
                              action="{{ route('panel.tag.update',$find->id)  }}">
                            {{ method_field("PATCH") }}
                            @else
                                <form class="form-horizontal" method="post"
